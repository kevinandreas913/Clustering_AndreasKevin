    ...
    <div class="container col-lg-6">
        ...
        <form id="form-barang" action="{{ route('barang.store') }}" method="POST">
            ...
            <!-- <div class="form-group mb-3">
                ...
                <input type="number" id="harga" name="harga" value="{{ old('harga') }}" placeholder="Masukkan nominal disini! (contoh 150000)" class="form-control @error('harga') is-invalid @enderror">
                @error('harga')
                <div class="text-danger">
                    {{$message}}
                </div>
