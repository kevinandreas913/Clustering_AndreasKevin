    ...
    <div class="container col-lg-6">
        ...
        <form id="form-penjualan" action="{{ url('/updatesale/'.$sales->uuid) }}" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" step="0.01" id="harga_unit" name="harga_unit" value="{{ old('harga_unit') ?? $sales->harga_unit }}" placeholder="Masukkan harga unit produk pada toko tersebut" class="form-control @error('harga_unit') is-invalid @enderror">
                @error('harga_unit')
                <div class="text-danger">
                    {{$message}}
                </div>
